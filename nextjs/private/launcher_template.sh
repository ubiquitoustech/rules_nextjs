...
case "${machine}" in
  ...
  darwin) readonly platform_main_manifest="TEMPLATED_npm_path/next/dist/bin/next" ;;
  windows) readonly platform_main_manifest="TEMPLATED_npm_path/next/dist/bin/next" ;;
  *) readonly platform_main_manifest="TEMPLATED_npm_path/next/dist/bin/next" ;;
esac
